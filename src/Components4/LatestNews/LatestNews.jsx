        ...
        <div className="mt-14 2xl:mt-[60px]">
          <div className="grid grid-cols-6 2xl:grid-rows-4 2xl:grid-flow-col gap-6 3xl:gap-[30px]">
            ...
            >
              <div className="overflow-hidden">
                <img
                  className="object-cover w-full h-[200px] sm:h-[350px] md:h-[234px] lg:h-[316px] xl:h-[375px] 2xl:h-[400px] md:rounded-none group-hover:scale-105  transition-all duration-300 2xl:w-[310px]"
                  src={blogs[1].img}
                  alt=""
                />
              </div>
